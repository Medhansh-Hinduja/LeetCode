class Solution {
    ...
    // // returns a 2 element array with the symbol to be concatenated to the string (if applicable) and
    // // the remaining number to be converted.
    // public String[] toAdd(int n) {
    //     String A[] = {"", ""};
    //     String sym[] = {"I", "V", "X", "L", "C", "D", "M"};
    //     int val[] = {1, 5, 10, 50, 100, 500, 1000, 4000};
    //     if (n==4) {
    //         A[0] = "IV";
    //         A[1] = "0"; 
    //     }
    ...
    //         for(int a=0; a<val.length-1; a++) {
    //             if(n >= val[a] && n < val[a+1]) {
    //                 A[0] = sym[a];
    //                 A[1] = Integer.toString(n-val[a]);
    //                 break;
    //             }
    //         }
    //     }
